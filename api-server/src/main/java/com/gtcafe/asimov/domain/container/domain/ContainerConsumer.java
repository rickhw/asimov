...
import com.gtcafe.asimov.domain.container.ContainerConfig;
...
public class ContainerConsumer implements Runnable {
    ...
    private String API__CREATE = "/containers/create";
    ...
    // public ContainerConsumer(String names) {
    //     this.taskName = name;
    //     // this.props = props;
    // }
    ...
    public void createContainer(String taskName) {
        ...
        try {
            ...
            ResponseEntity<Map> response = restTemplate.postForEntity(
                    config.getHostname() + "/api/v1alpha/hello", request, Map.class);
        ...
        while (true) {
            ...
            try {
                ResponseEntity<Map> response = restTemplate.getForEntity(
                        config.getHostname() + "/api/v1alpha/tasks/" + taskId, Map.class);
